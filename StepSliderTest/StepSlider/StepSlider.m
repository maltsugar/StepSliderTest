...
- (void)layoutLayersAnimated:(BOOL)animated
{
    ...
    contentSize = CGSizeMake(fmaxf(20.f, self.bounds.size.width), fmaxf(20.f, sliderHeightWithLabels));
    
    
//    NSLog(@"%@   %@", NSStringFromCGRect(self.bounds), NSStringFromCGSize(contentSize));
